...
<div class="seg-hero">
    <div class="seg-hero__brand">
        ...
        <div>
            <h1 class="seg-hero__title">Nuevo seguimiento Maestro SIV 549</h1>
            <p class="seg-hero__subtitle">Registra el seguimiento del caso asignado con una vista mas clara, manteniendo intacto el flujo actual de guardado.</p>
        </div>
    </div>
...
<div class="container-fluid px-0">
    ...
    <div class="card card-outline card-primary seg-card">
        <div class="card-header border-0">
            ...
            <h3 class="card-title seg-card__title">
                <i class="fas fa-notes-medical mr-1"></i> Registro del seguimiento
            </h3>
        </div>
        <div class="card-body">
