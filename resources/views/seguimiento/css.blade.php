...
<style>
    ...
    .seg113-kpi-card__label{
        display:block;
        font-size:.9rem;
        color:#617f89;
        font-weight:700;
    }
    .seg113-kpi-card__value{
        display:block;
        font-size:1.8rem;
        font-weight:800;
        line-height:1.1;
    ...
    .stat-abiertos .seg113-kpi-card__icon{
        background:linear-gradient(135deg, #178cb1, #0f6f92);
    }
    .stat-proximos .seg113-kpi-card__icon{
        background:linear-gradient(135deg, #1aa36e, #1c8f63);
    }
    .stat-cerrados .seg113-kpi-card__icon{
    ...
    #seguimiento.table-hover tbody tr:hover{
        background:#f3fbfd;
    }
