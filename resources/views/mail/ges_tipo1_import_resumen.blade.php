...
<head>
    <meta charset="utf-8">
    <title>Resumen Cargue Gestantes Tipo 1</title>
</head>
<body style="font-family: Arial, sans-serif; color: #1f2937;">
    <h2 style="margin:0 0 12px 0;">Resumen de Cargue Gestantes Tipo 1</h2>
    ...
    <table cellpadding="6" cellspacing="0" border="1" style="border-collapse:collapse; font-size:13px;">
        ...
        <tr><td><strong>Duplicados detectados</strong></td><td>{{ (int)($counters['rows_duplicated'] ?? 0) }}</td></tr>
        <tr><td><strong>Filas omitidas</strong></td><td>{{ (int)($counters['rows_skipped'] ?? 0) }}</td></tr>
        <tr><td><strong>Filas invalidas</strong></td><td>{{ (int)($counters['rows_invalid'] ?? 0) }}</td></tr>
        <tr><td><strong>Errores detectados</strong></td><td>{{ (int)($counters['errors_count'] ?? 0) }}</td></tr>
