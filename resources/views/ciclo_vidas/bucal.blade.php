{{-- resources/views/ciclo_vidas/bucal.blade.php --}}
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title mb-0">Detalle de atenciones en salud bucal</h3>
        </div>
        <div class="card-body">
...
@section('js')
    ...
    <script>
        $(function () {
            ...
            // Fechas por defecto del controlador
            ...
            // KPIs desde el JSON del server-side
