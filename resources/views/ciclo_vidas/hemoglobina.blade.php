{{-- resources/views/ciclo_vidas/hemoglobina.blade.php --}}
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title mb-0">Detalle de atenciones por hemoglobina</h3>
        </div>
        <div class="card-body">
    ...
    <script>
        $(function () {
            ...
            const tabla = $('#tabla').DataTable({
                ...
                processing: true,
                ajax: {
                    url: "{{ route('pi.nutri.hemoglobina.data') }}",
                    type: 'GET',
                    data: function (d) {
              ...
              columns: [
                ...
                { data: 'edad', name: 'edad' },
                { data: 'edadMeses', name: 'edadMeses' }, // 👈 añadido (opcional)
