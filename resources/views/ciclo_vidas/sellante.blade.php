{{-- resources/views/ciclo_vidas/sellante.blade.php --}}
@extends('adminlte::page')

@section('title', 'PI Bucal - Sellantes')

@section('content_header')
    <div class="d-flex align-items-center">
        <a href="{{ route('pi.bucal.index') }}" class="btn btn-sm btn-outline-secondary mr-2">
            <i class="fas fa-arrow-left"></i> Volver
        </a>
        <div>
            <h1 class="mb-0">Atenciones – Sellantes</h1>
            <small class="text-muted">Datos en vivo (server-side)</small>
        </div>
    </div>
@stop
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title mb-0">Detalle de atenciones</h3>
        </div>
        <div class="card-body">
...
@section('js')
    ...
    <script>
        $(function () {
            ...
            // Fechas por defecto desde el controlador
            ...
            const tabla = $('#tabla').DataTable({
                ...
                processing: true,
                ajax: {
                    url: "{{ route('pi.bucal.sellantes.data') }}",
                    type: 'GET',
                    data: function (d) {
