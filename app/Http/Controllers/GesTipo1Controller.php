...
class GesTipo1Controller extends Controller
{
    ...
    private function tipo1ReportColumns(): array
    {
        return [
            ...
            'pais_nacionalidad' => ['label' => 'Pais nacionalidad', 'db' => 'g.pais_de_la_nacionalidad'],
            ...
            'codigo_ocupacion' => ['label' => 'Codigo ocupacion', 'db' => 'g.codigo_de_ocupacion'],
            'codigo_nivel_educativo' => ['label' => 'Codigo nivel educativo', 'db' => 'g.codigo_nivel_educativo_de_la_gestante'],
            ...
            'autoinmune' => ['label' => 'LES autoinmune', 'db' => 'g.antecedente_les_enfermedad_autoinmune'],
            'sindrome_metabolico' => ['label' => 'Sindrome metabolico', 'db' => 'g.antecedente_sindrome_metabolico'],
            'erc' => ['label' => 'ERC', 'db' => 'g.antecedente_erc'],
            'trombofilia' => ['label' => 'Trombofilia', 'db' => 'g.antecedente_trombofilia_o_trombosis_venosa_profunda'],
            'anemia_celulas_falciformes' => ['label' => 'Anemia celulas falciformes', 'db' => 'g.antecedentes_anemia_celulas_falciformes'],
            'sepsis_previa' => ['label' => 'Sepsis previa', 'db' => 'g.antecedente_sepsis_durante_gestaciones_previas'],
            'consumo_tabaco' => ['label' => 'Consumo tabaco', 'db' => 'g.consumo_tabaco_durante_la_gestacion'],
            ...
            'batch_verifications_id' => ['label' => 'Batch verification', 'db' => 'g.batch_verifications_id'],
            'id' => ['label' => 'ID', 'db' => 'g.id'],
