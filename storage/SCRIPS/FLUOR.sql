...
WHERE A.codigoProcedimiento IN ('997106') 
and a.diagnostico in ('Z001','Z002','Z003') AND
...
where codProcedimiento in ('997106')  and
coddiagnosticoPrincipal IN ('Z001','Z002','Z003') AND
