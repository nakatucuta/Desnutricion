...
WHERE A.codigoProcedimiento IN ('906249') AND
a.diagnostico in ('Z000','Z003','Z114') AND
...
where codProcedimiento in ('906249')  and
coddiagnosticoPrincipal IN ('Z000','Z003','Z114') AND
