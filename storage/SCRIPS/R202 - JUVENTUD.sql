...
IF OBJECT_ID('tempdb..#r202_juventud_base') IS NOT NULL DROP TABLE #r202_juventud_base;
IF OBJECT_ID('tempdb..#r202_juventud_ids') IS NOT NULL DROP TABLE #r202_juventud_ids;
...
CREATE INDEX IX_r202_juventud_base_identificacion
    ON #r202_juventud_base (identificacion);
...
SELECT
    ...
    identificacion,
    numeroCarnet
INTO #r202_juventud_ids
FROM ids
WHERE rn = 1;

CREATE UNIQUE CLUSTERED INDEX IX_r202_juventud_ids_identificacion
    ON #r202_juventud_ids (identificacion);
...
FROM #r202_juventud_base B
INNER JOIN #r202_juventud_ids X
