...
WHERE A.codigoProcedimiento IN ('892901','898015') AND
a.diagnostico in ('Z000','Z003','Z124') AND
...
where codProcedimiento in ('892901','898015')  and
coddiagnosticoPrincipal IN ('Z000','Z003','Z124') AND
