...
where codigoConsulta in ('890205','890305','890105')  and
diagnosticoPrincipal IN ('Z001','Z000','Z003') AND
...
where codConsulta in ('890205','890305','890105')  and
coddiagnosticoPrincipal IN ('Z001','Z000','Z003') AND
